...
function getFlyValue(bulletNum,trailNum){
    ...
    if(bulletInfo.bulletsData.bullets[bulletNum]){
        if(bulletInfo.bulletsData.bullets[bulletNum].cycles[trailNum]){
            ...
            bulletInfo.bulletsData.bullets[bulletNum].cycles[trailNum].flyObstructionForce = parseFloat($('#flyContorlResisInpX'+'_'+bullets+'_'+trails).val());
            ...
            bulletInfo.bulletsData.bullets[bulletNum].cycles[trailNum].obstructionForce = parseFloat($('#elasticControlInp'+'_'+bullets+'_'+trails).val());
        }
    }
...
function getTriggerResult(num,bulletNum,trailNum,resultNum){
    ...
    if(bulletInfo.bulletsData.bullets[bulNum]){
        if(bulletInfo.bulletsData.bullets[bulNum].cycles[traNum]){
            if(bulletInfo.bulletsData.bullets[bulNum].cycles[traNum].triggers[nowNum]){
                if(bulletInfo.bulletsData.bullets[bulNum].cycles[traNum].triggers[nowNum].effects[resNum]){
...
function switchTopSelVal(top,num,bulletNum,trailNum,resultNum){
    if($('#time'+ '_' + num + '_' + bulletNum + '_' + trailNum).length){
        if($('#time'+ '_' + num + '_' + bulletNum + '_' + trailNum).prop('value')){
