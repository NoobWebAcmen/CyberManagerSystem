                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="block-content collapse in">
                           ...
                           <form class="form-horizontal" method="post" action="searchPage.php">
                           <fieldset>
                             <legend>搜索用户</legend>
                             <div class="control-group">
                               <label class="control-label" for="focusedInput">id</label>
                               <div class="controls">
                                 <input class="input-xlarge focused" id="focusedInput" type="text" datatype="n" name="id" ignore="ignore" errormsg="id只能为数字！">
                             ...
                             <div class="controls">
                               <input class="input-xlarge focused" id="focusedInput" type="text"  name="name" datatype="alpha" ignore="ignore" errormsg="姓名只能为汉字或者字母！"/>
                               <span class="Validform_checktip"></span>
                              </div>
                           </div>
                             <div class="control-group">
                               ...
                               <div class="controls">
                                 <input class="input-xlarge focused" id="focusedInput" type="text" datatype="n" name="grade" ignore="ignore" errormsg="级别只能为数字！">
                                 <span class="Validform_checktip"></span>
                                </div>
                             </div>
                             <div class="control-group">
                               ...
                               <div class="controls">
                                 <input class="input-xlarge focused" id="focusedInput" type="text" datatype="e" name="email" ignore="ignore" errormsg="邮箱无效">
                                 <span class="Validform_checktip"></span>
                                </div>
                             </div>
                             <div class="control-group">
                               ...
                               <div class="controls">
                                 <input class="input-xlarge focused" id="focusedInput" type="text" datatype="n" name="salary" ignore="ignore" errormsg="薪水只能为数字">
                                 <span class="Validform_checktip"></span>
                                </div>
                             </div>
                             <input type="hidden" name="flag" value="searchemp"/>   <!-- 通过隐藏域将参数传递给 form action 指定的文件 -->
