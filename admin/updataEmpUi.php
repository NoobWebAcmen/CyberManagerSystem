                           ...
                           <form class="form-horizontal" method="post" action="empProcess.php">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $emp->getId();?>" name="id"  readonly="true">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">名字</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $emp->getName();?>" name="name" datatype="alpha" ignore="ignore" errormsg="姓名只能为汉字或者字母！">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $emp->getGrade();?>" name="grade" datatype="n" name="grade" ignore="ignore" errormsg="级别只能为数字！">
                                            <span class="Validform_checktip"></span>
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $emp->getEmail();?>" name="email" datatype="e" name="email" ignore="ignore" errormsg="邮箱无效">
                                            <span class="Validform_checktip"></span>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $emp->getSalary();?>" name="salary" datatype="n" name="salary" ignore="ignore" errormsg="薪水只能为数字">
                                            <span class="Validform_checktip"></span>
                                        </div>
                                        </div>
                                        <input type="hidden" name="flag" value="updataemp"/>   <!-- 通过隐藏域将参数传递给 form action 指定的文件 -->
