                    ...
                    <div class="row-fluid clear">
                        ...
                        <div id="bulletsMod_1" class = "fl parentHiddTag hidd ChariotOptionsClass"> 
                            ...
                            <div id="speedMod_1" class="flyControlDiv">
                                <p class="flyControlP1 P2">速度</p>
                                <input type="text" id="speedModInp_1" class="flyBeginAxies" />
                            </div>
                            <div id="sizeMod_1" class="flyControlDiv">
                                <p class="flyControlP1 P3">宽 高</p>
                                <label for="" class="flyBeginLab">W: </label>
                                <input type="text" id="sizeModWid_1" class="flyBeginInpAxies" />
                                <label for="" class="flyBeginLab">H: </label>
                                <input type="text" id="sizeModHei_1" class="flyBeginInpAxies" />
                            </div>
                            <div id="massMod_1" class="flyControlDiv">
                                <p class="flyControlP1 P4">Mass</p>
                                <input type="text" id="massModInp_1" class="flyBeginAxies" />
                            </div>
                            <div id="rotationMomentMod_1" class="flyControlDiv">
                                <p class="flyControlP1 P5">旋转时间</p>
                                <input type="text" id="rotationMomentModInp_1" class="flyBeginAxies" />
                            </div>
                            <div id="saveMod_1">
                                <button class="flyControlBtn" id="saveModBtn_1">保存</button>
                        ...
                        <div id="triggerConditionMod_1_1_1" class="clear parentHiddTag hidd triggerConditionModClass">
                            <div id="triggerConditons_1_1_1" class="clear triggerConditonsClass"> 
                                <div class="triggerSel triggerTop fl">
                                    <p class="triggerConditonP fl" id="triggerConditonsP_1_1_1">触发条件1
