...
<html>
            ...
            <div class="span3" id="sidebar">
                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="block-content collapse in  clear" >
                           <div class="span12" >
                                   <div class="table-toolbar clear">
                                      ...
                                      <div class="btn-group pull-right">
                                         <a href="searchEmp.php"><button class="btn btn-success ">搜索 <i class="icon-plus icon-white"></i></button></a>
                                      </div>
                                   </div>
                                   ...
                                   <thead>
                                       ...
                                       //显示所有用户的信息,分页
                                            ...
                                            if(!isset($paging->pageSize)){
                                                ...
                                                $paging->pageSize = $_GET['rows'];
                                            }else{

                                                $paging->pageSize = 10;
                                            }
                                            $paging->gotourl='admin_limit.php?rows='.$rows;
                                            ...
                                            $empService->getPaging($paging);  //返回的一个二维数组
                                           
                                           $pageNow = $paging->pageNow;
                               ...
                               <div class=" clear admin_tool_bar">
                                    <div class="span6 pull-left">
                                            <div id="example_length" class="dataTables_length">
                                                <form action="admin_limit.php" method="get" class="form_style clear " >
                                                    <label class="datalabel ">
                                                            每页显示行数
                                                        <select name="rows" size="1" aria-controls="example" id="pagesize" >
                                                               
                                                            <option value="5"  name="option1" >5</option>
                                                            <option value="10"   name="option2" >10</option>
                                                            <option value="15" name="option3" >15</option>
                                                            <option value="20" name="option4">20</option>
                                                        </select>
                                                        <input type="hidden">
                                                    </label>    
                                                </form>
                                            ...
                                            <div class="span6 pull-right">
                                                <form action="admin_limit.php" class="form_style pull-right" id="input_form" method="GET">
                                                跳转到第：
                                                    <input type="text" name="pageNow" class="input_text_style" datatype="n" />
                                                    <input type="hidden" name="rows" value="" id="toPage"/>
                                                    <span>&nbsp/&nbsp<span>
                                                    <?php echo $GLOBALS['pageCount'].'页'?>
                                                </form>
                                            </div>
                                    </div>
    ...
    <script>
       ...
       var se = document.getElementById('pagesize');
       ...
       se.onchange = function(){
           ...
           window.location='?rows='+this.value+'&'+'pageNow='+<?php echo $GLOBALS['pageNow'];?>;
       ...
       window.onload = function(){
           ...
           $('#toPage').attr('value',localStorage.value);
       }

        $(function() {

            $(".form_style").Validform({
		        tiptype:1
            });
